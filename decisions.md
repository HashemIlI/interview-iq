...
| **Q6 — AraT5 vs mT5-base** | اختيار موديل الـ decomposition. G2 مغلقة (D52)؛ pilot تشخيصي مُسجَّل مسبقًا في **D53** (5 أسئلة، zero-shot، تقييم اتجاهي يدوي). | ⛔ نشطة — pilot مسجَّل D53، بانتظار تشغيل Kaggle |
