...
| # | البند | التفصيل |
|---|---|---|
| Q1 | **تعارض ترقيم القرارات D##** | D21 يُشير في الوثيقة الرئيسية إلى Option B Dual-Channel، بينما decisions.md في جلسة الـ pipeline استخدم D21–D26 لقرارات بيانات الـ NLI (منها HARD_POS twins وقاعدة الـ per-doc quota). يلزم توحيد سجل واحد بترقيم واحد قبل التنفيذ. |
...
| Q9 | **مستودع GitHub** | اسم المستخدم/الـ repo URL الفعلي غير محدد بعد (مطلوب لنوتبوكات الـ Runners). |
